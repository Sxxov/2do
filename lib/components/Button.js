...
import { X, css, html, ifDefined } from '../common/x/X.js';
import './Ripples.js';
import './Spacer.js';
...
export class Button extends X {
	...
	static properties = {
		...
		form: strT,
		shadow: strT(cssT),
		shadowHover: strT(cssT),
		shadowActive: strT(cssT),
		shadowDisabled: strT(cssT),
		...
		/** @satisfies {import('../common/x/X.js').Variants<Button>} */ ({
			...
			transparent: {
				...
				'.colourBackgroundActive':
					'var(----colour-background-secondary)',
				'.colourBackgroundDisabled':
					'var(----colour-background-transparent)',
				'.colourText': 'var(----colour-text-primary)',
				'.colourTextHover': 'var(----colour-text-primary)',
				'.colourTextActive': 'var(----colour-text-primary)',
				'.colourTextDisabled': 'var(----colour-text-secondary)',
			...
			flatRight: {
				'.roundness': 'var(----roundness) 0 0 var(----roundness)',
				'.padding':
					'16px calc(var(----roundness) - 3.5px) 16px var(----roundness)',
			},
			flatLeft: {
				'.roundness': '0 var(----roundness) var(----roundness) 0',
				'.padding':
					'16px var(----roundness) 16px calc(var(----roundness) - 3.5px)',
			},
			flat: {
				'.roundness': '0',
				'.padding': '16px calc(var(----roundness) - 3.5px)',
			},
			shadowNone: {
				'.shadow': 'none',
				'.shadowHover': 'none',
			...
			shadowSm: {
				...
				'.shadowHover': 'var(----shadow-inner-sm), var(----shadow-sm)',
				'.shadowActive': 'var(----shadow-inner-md), var(----shadow-sm)',
			},
			shadowInner: {
				'.shadow': 'var(----shadow-inner-sm)',
				'.shadowHover': 'var(----shadow-inner-sm)',
				'.shadowActive': 'var(----shadow-inner-md)',
			},
		});
	...
	constructor() {
		...
		/** @type {string} */ this.padding = '16px max(var(--roundness), 24px)';
		/** @type {boolean} */ this.disabled = false;
		/** @type {'button' | 'submit' | 'reset'} */ this.type = 'button';
		/** @type {string | undefined} */ this.form;
		/** @type {string} */ this.shadow =
			'var(----shadow-inner-sm), var(----shadow-md)';
		/** @type {string} */ this.shadowHover =
			'var(----shadow-inner-sm), var(----shadow-md)';
		/** @type {string} */ this.shadowActive =
			'var(----shadow-inner-sm), var(----shadow-none)';
		/** @type {string} */ this.shadowDisabled =
			'var(----shadow-inner-sm), var(----shadow-none)';
